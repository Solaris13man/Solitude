...
const PAGES = [
  ...
  { slug: 'spades', title: 'Spades', label: 'Bid, partner up, race to 500', motif: '♠' },
  { slug: 'gin', title: 'Gin Rummy', label: 'Meld, knock, chase gin', motif: '♦' },
  { slug: 'euchre', title: 'Euchre', label: 'Order up trump, race to 10', motif: '♣' },
